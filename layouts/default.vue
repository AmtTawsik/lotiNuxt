<template>
    <div>
      <nav class="gradient border-gray-200 dark:bg-gray-900">
        <div class="w-full flex flex-wrap items-center justify-between mx-auto p-4">
          <a href="https://flowbite.com/" class="flex items-center">
            <span class="self-center text-2xl md:text-2xl font-bold whitespace-nowrap dark:text-white">Qualyval</span>
          </a>
          ...
          <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul
              class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  md:bg-none md:flex-row md:space-x-8 md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
  ...
  <style scoped>
  .gradient {
    background: linear-gradient(90deg, #37C6AB 0%, #517CDA 100%);
  }
  </style>